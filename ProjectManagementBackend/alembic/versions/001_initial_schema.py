...
def upgrade() -> None:
    ...
    workspace_role = postgresql.ENUM("owner", "admin", "member", name="workspace_role", create_type=True)
    ...
    task_status = postgresql.ENUM(
        "todo", "in_progress", "in_review", "done", name="task_status", create_type=True
    )
    task_priority = postgresql.ENUM(
        "low", "medium", "high", "urgent", name="task_priority", create_type=True
    )
